 ...
 * USDC token interactions (balanceOf / allowance / approve).
 */

import contestModuleArtifact from './ContestModule.json' with { type: 'json' };
import creOracleReceiverArtifact from './CreOracleReceiver.json' with { type: 'json' };
...
export const creOracleReceiverAbi = creOracleReceiverArtifact.abi;
