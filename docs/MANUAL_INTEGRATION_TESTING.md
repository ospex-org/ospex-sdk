...
| 1.5 | `ospex speculations show <speculationId>` (pick one from 1.4) | Single speculation with `orderbook[]` + the parent `contest` block (13 keys) | `client.speculations.get`. |
